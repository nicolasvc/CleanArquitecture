package com.example.cleanarquitecture.bussiness.data.cache
...
constructor(
    ...
    override suspend fun deleteNote(primaryKey: String): Long {
    ...
    override suspend fun deletesNotes(notes: List<Note>): Int {
        var failOrSuccess = 1
        for(note in notes){
